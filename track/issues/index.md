...
Índice dos 11 tickets (tracer bullets) que implementam o módulo `tracks`, no formato das issues `type:feat` da casa (padrão stherzada). Dependências entre tickets: ver o [grafo no índice do módulo](../index.md).
